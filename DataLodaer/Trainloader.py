...
class DataSet(object):
    def __init__(self, config):
        ...
        self.train_img_list, self.train_label_list = self.get_list(self.cfg.train_dir)

        self.train_dataset = TrainDataSetDefine(self.train_img_list, self.train_label_list, self.cfg)
