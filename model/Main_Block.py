...
from model.Block1 import Block1
from model.Block2 import Block2
...
class Main_Block(nn.Module):
    def __init__(self):
        ...
        self.up_1 = Block2(block_num=4, inter_channel=32, channel=64, grid=[8, 8])
        self.up_2 = Block2(block_num=4, inter_channel=32, channel=64, grid=[4, 4])
        self.up_3 = Block2(block_num=4, inter_channel=32, channel=64, grid=[2, 2])

        self.down_3 = Block1(block_num=4, inter_channel=32, channel=64)
        self.down_2 = Block2(block_num=4, inter_channel=32, channel=64, grid=[2, 2])
        self.down_1 = Block2 (block_num=4, inter_channel=32, channel=64, grid=[4, 4])
